...
class BackupApp: public Application
	...
	void defineOptions(OptionSet& options)
	{
		...
		options.addOption(
			Option("define", "D", "define a configuration property")
				...
				.repeatable(true)
				.argument("name=value")
				.callback(OptionCallback<BackupApp>(this, &BackupApp::handleDefine)));
		...
		options.addOption(
			Option("config-file", "f", "load configuration data from a file")
				...
				.repeatable(true)
				.argument("file")
				.callback(OptionCallback<BackupApp>(this, &BackupApp::handleConfig)));
		...
		options.addOption(
			Option("task-file", "t", "load tasks from a file")
				...
				.repeatable(true)
				.argument("file")
				.callback(OptionCallback<BackupApp>(this, &BackupApp::handleLoadTasks)));
	}
